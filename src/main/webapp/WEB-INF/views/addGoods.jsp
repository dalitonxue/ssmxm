    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                ...
                <p>商品的一些基本信息</p>
                <form action="${pageContext.request.contextPath}/admin/goods/addGoodsSuccess" class="templatemo-login-form"
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12">
                            ...
                            <input type="file" name="fileToUpload" id="fileToUpload" class="filestyle"
                                   data-buttonName="btn-primary" data-buttonBefore="true" data-icon="false" multiple="multiple">
                            <!-- <p>Maximum upload size is 5 MB.</p>  -->
                        </div>
                    </div>
                    <div class="form-group text-right">
                        <button type="submit" id="addGood" class="templatemo-blue-button">添加</button>
...
<script>
    $("#addGood").on("click",function () {
        ...
        var fileToUpload = $("input[name='fileToUpload']").val();
