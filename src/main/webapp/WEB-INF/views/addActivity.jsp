            ...
            <div class="templatemo-content-widget white-bg">
                ...
                <form action="${pageContext.request.contextPath}/admin/activity/addResult" class="templatemo-login-form" method="post">
                    ...
                    <div class="form-group text-right">
                        <button type="submit" class="templatemo-blue-button" id="addActivity">添加</button>
...
<script>
    $("#addActivity").on("click",function () {
        var inputWithSuccess = $("#inputWithSuccess").val();
        var inputWithDiscount = $("#inputWithDiscount").val();
