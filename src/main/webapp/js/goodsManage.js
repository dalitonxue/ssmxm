...
function build_goods_table(path,result) {
    ...
    $.each(goods, function (index,item) {
        ...
        var detailBtn = $('<button type="button" class="description" ' +
            'data-container="body" data-toggle="popover" data-placement="top"></button>').append("描述");
        ...
        $("<tr></tr>").append(goodsid).append(goodsname).append(price).append(num).append(detailcate)
            .append(activityid).append(desTd).append(detailTd).append(editTd).append(deleteTd).append(actTd).appendTo("#goodsinfo tbody");
    })
}
