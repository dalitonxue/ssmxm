...
function build_cart_table(result) {
    ...
    if(goods.length === 0) {
        var spareTd = $('<tr> <td colspan="6"> ' +
            '<div class="coupon" style="margin-left:37%;">购物车还是空的，快去' +
            '<a href="/shop/main" style="color:red;">首页</a>看看吧！ </div> </td> </tr>');
        ...
        $.each(goods, function (index,item) {
            ...
            var goodsitem = $("<tr></tr>").append(deleteCart)
                .append(shopimage).append(goodsname)
                .append(goodsprice).append(num)
                .append(totalPrice).appendTo("#cart-table tbody");
            totalnum++;
